...
$(document).ready(function () {
    ...
    $("#open-card-overlay").click(function() {
        ...
        if (openCardWindowShow) {
            ...
            var full_name = localStorage.getItem('fullname') ? localStorage.getItem('fullname') : "Viktor Strand";
            $("#card1-fullname,#card2-fullname").text(full_name);
            var personal_number = localStorage.getItem('PN') ? localStorage.getItem('PN'): "930616-0491";
            ...
            var qr_info = '{"pnr":"'+qr_info_pnr+'","fn":"'+qr_info_fn+'","ln":"'+qr_info_ln+'","id":"dzDSqrSKIietOXBftRDdHZ%3D%3D","o2":"STUDENTKORTET I SVERIGE","o2id":6325,"o3":"ÖVRIGA","o3id":5631,"o4":"","o4id":"","valid":"2023-09-15","dt":"2022-11-29 15:29:44","check":"cuifuhp1kyzeo2efa0ko3idbzoaoo81g"}';
